...
class PurchaseRepository {
  ...
  async getByUserId(db, tenantId, filters = {}) {
    ...
    const filterConfig = {
      ...
      min_total_amount: { operator: ">=", column: "p.total_amount" },
      max_total_amount: { operator: "<=", column: "p.total_amount" },
      paid_amount: { operator: "=", column: "p.paid_amount" },
      min_paid_amount: { operator: ">=", column: "p.paid_amount" },
      max_paid_amount: { operator: "<=", column: "p.paid_amount" },
      due_amount: { operator: "=", column: "(p.total_amount - p.paid_amount)" },
      min_due_amount: { operator: ">=", column: "(p.total_amount - p.paid_amount)" },
      max_due_amount: { operator: "<=", column: "(p.total_amount - p.paid_amount)" },
      min_discount: { operator: ">=", column: "p.discount" },
      max_discount: { operator: "<=", column: "p.discount" },
      start_date: { operator: ">=", column: "p.date::DATE" },
      end_date: { operator: "<=", column: "p.date::DATE" },
