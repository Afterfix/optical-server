module.exports = async (client) => {
  try {
    ...
    console.log("✅ sale_item table updated (frame_id, frame_variant_id, lens_id, lens_addon_id columns dropped if they existed).");
...
//addnewfields item_id unit_price and remove  frame_variant_id, lens_id, lens_addon_id ,frame_price, lens_price, addon_price
`
DO $$ 
BEGIN
